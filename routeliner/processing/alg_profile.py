...
class ProfileTable(RoutelinerAlgorithm):
    ...
    HELP = (
        ("Собирает точки продольного профиля по каждому маршруту и снимает в них значения "
         ...
         "(переходы, колодцы, скважины) ставятся по проекции на ось, если лежат в "
         "коридоре от оси.\n"
         "\n"
         ...
         "- z_axis - отметка оси по Z маршрута, пусто, если у маршрута нет Z или все Z "
         "нулевые\n"
...
class ProfileDrawing(RoutelinerAlgorithm):
    ...
    HELP = (
        ...
        "бумаги, так что одна единица карты равна миллиметру. В компоновке QGIS профиль печатается "
