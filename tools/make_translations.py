...
"Система пикетажа (значение": "Chainage system (value of the system field)",
"Ошибки": "Errors",
...
"влево": "left",
"вправо": "right",
"Условный горизонт {z": "Datum {z:.2f}",
"М 1:{v:g} по вертикали": "Vertical scale 1:{v:g}",
"М 1:{h:g} по горизонтали": "Horizontal scale 1:{h:g}",
"ВУ{n}": "PI{n} {a:.1f}° {side}",
"5. Профили": "5. Profiles",
...
"Высота, мм": "Height, mm",
"Линия (1/0)": "Line (1/0)",
"только с поворотом или изломом уклона": "only with a turn or a grade break",
"все вершины": "all vertices",
"без вершин": "no vertices",
"Отметка земли проектная, м": "Design ground level, m",
"Отметка земли фактическая, м": "Existing ground level, m",
"Отметка верха трубы, м": "Pipe top level, m",
"Отметка дна траншеи, м": "Trench bottom level, m",
"Расстояние земля - труба, м": "Ground to pipe, m",
"Глубина траншеи, м": "Trench depth, m",
"Обозначение трубы и тип изоляции": "Pipe type and coating",
"Основание": "Bedding",
"Уклон, ‰ / длина, м": "Grade, ‰ / length, m",
"Расстояние, м": "Distance, m",
"Пикет": "Station",
"Развёрнутый план": "Straightened plan",
"Поле отметки земли {ground}": "Ground level field {ground}",
"Поле проектной отметки {design}": "Design level field {design}",
"Поле отметки трубы или оси {pipe}": "Pipe or axis level field {pipe} (empty - z_axis)",
"Участки: поле ID маршрута": "Sections: route ID field",
"Участки: поле меры начала": "Sections: start measure field",
"Участки: поле меры конца": "Sections: end measure field",
"Маршруты через запятую": "Routes separated by commas (empty - all)",
"Растры (рельеф": "Rasters (terrain, design surface, seam)",
"Номер канала растров": "Raster band number",
"Точки на целых пикетах через": "Points at whole pickets every, m (0 - none)",
"Точки с постоянным шагом": "Points with a constant step, m (0 - none)",
"Вершины оси": "Axis vertices",
"События на профиль: точки": "Events for the profile: points (optional)",
"События: поле подписи": "Events: label field",
"События: коридор от оси, м": "Events: corridor from the axis, m",
"Маршрут (пусто - первый в таблице)": "Route (empty - the first in the table)",
"Наружный диаметр трубы {d}, м": "Pipe outer diameter {d}, m",
"Толщина основания {base}, м": "Bedding thickness {base}, m",
"Строки сетки профиля": "Profile grid rows",
"Участки для текстовых строк": "Sections for text rows (optional)",
"Точки для развёрнутого плана": "Points for the straightened plan (result of 4.02, optional)",
"План: поле подписи": "Plan: label field",
"Масштаб по горизонтали 1:": "Horizontal scale 1:",
"Масштаб по вертикали 1:": "Vertical scale 1:",
"Условный горизонт, м": "Datum, m (empty - automatic)",
"Допуск выделения уклонов, м": "Grade detection tolerance, m",
"Наименьший промежуток между подписями, мм": "Smallest gap between labels, mm",
"Левый нижний угол профиля над сеткой": "Lower left corner of the profile above the grid (empty - below the routes)",
"Профиль, линии": "Profile, lines",
"Профиль, подписи": "Profile, labels",
"Не задана таблица профиля": "The profile table is not set",
"В слое плана нужны поля rl_m и rl_offset": "The plan layer needs the fields rl_m and rl_offset (result of 4.02)",
"Итого: точек профиля {n}, растров {r}": "Total: profile points {n}, rasters {r}",
"Профиль маршрута «{rid}»": "Profile of route «{rid}»: rows {r}, width {w:.0f} mm, datum {h:.2f}",
"В таблице нет точек маршрута «{rid}»": "The table has no points of route «{rid}»",
"В слое участков нет полей меры": "The section layer has no measure fields «{a}» and «{b}»",
"В таблице нет поля «{f}»": "The table has no field «{f}», the table of tool 5.01 is needed",
"не задано: {names}": "not set: {names}",
"Рельеф": "Terrain",
"Профиль: отметки рельефа совпали": "Profile: terrain levels match {a} of {n} (largest deviation {w:.1f} mm), R1 axis levels {b} of {m}, R3 equations {e} of 2, drawing built: {v}",
"Строка «{t}»: неизвестный тип «{k}»": "Row «{t}»: unknown type «{k}»",
...
"Мера, м": "Measure, m",
"Азимут, °": "Azimuth, °",
"Мера начала, м": "Start measure, m",
"Мера конца, м": "End measure, m",
"Длина участка, м": "Section length, m",
"Пикет начала": "Start station",
"Пикет конца": "End station",
"Начало и конец поменяны": "Start and end swapped",
"Маршрут": "Route",
"Смещение от оси, м": "Offset from the axis, m",
"Сторона": "Side",
"Код ошибки": "Error code",
"Пояснение ошибки": "Error explanation",
"Эталон, мера, м": "Reference, measure, m",
"Эталон, X": "Reference, X",
"Эталон, Y": "Reference, Y",
"Эталон, код ошибки": "Reference, error code",
"Эталон, мера начала, м": "Reference, start measure, m",
"Эталон, мера конца, м": "Reference, end measure, m",
"Эталон, маршрут": "Reference, route",
"Эталон, пикетаж, м": "Reference, chainage, m",
"Эталон, смещение, м": "Reference, offset, m",
"ID маршрута": "Route ID",
"Длина по оси, м": "Length along the axis, m",
"Частей": "Parts",
"Разрывов": "Gaps",
"Наибольший разрыв, м": "Largest gap, m",
"Пикетаж": "Chainage",
"Участок пикетажа": "Chainage section",
"Целый километр": "Whole kilometre",
"Номер точки": "Point number",
"Вид": "Kind",
"Пикетаж вперёд": "Chainage ahead",
"Отметка оси, м": "Axis level, m",
"Угол поворота, °": "Turn angle, °",
"Подпись": "Label",
"Строка сетки": "Grid row",
"Цвет": "Colour",
"Толщина линии, мм": "Line width, mm",
"Текст": "Text",
"Поворот, °": "Rotation, °",
"Высота текста, мм": "Text height, mm",
"Выравнивание по горизонтали": "Horizontal alignment",
"Выравнивание по вертикали": "Vertical alignment",
"Название": "Name",
"Система пикетажа": "Chainage system",
"Примечание": "Note",
